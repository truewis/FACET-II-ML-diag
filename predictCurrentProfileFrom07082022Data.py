...
bsaScalarData = np.load('data/processed/bsaScalarData.npy')
currentProfiles = np.load('data/processed/driverPeak.npy')
# Scandata is in the following columns [L1p,L2p,L1v,L2v,Qi,bc11pkI,bc14pkI,IPpkI,bc11.centroidx,bc14.centroidx]
bsaScalarData = np.transpose(bsaScalarData['bsaScalarCatwFWHMSYAG']);
Iz = np.transpose(currentProfiles['currProfCat']); 
...
# import joblib
# dirr = 'ML_CurrProfilePredictions/'
# # Save to file in the current working directory
# joblib_file = dirr+"nn_model_singleBunch_currprof_E327_07082022reluwFWHMSYAGAsInput.pkl"  
